...
import com.droidconcepts.wallpapers.R;
 ...
 * using the application. If the user accepts the EULA, it will never
 * be shown again. If the user refuses, the app will close. 
 */
class Eula {
